...
class RegisterWalletMutationTest {
    ...
    void 'Register Pay later wallets handle exceptions'() {
        ...
        def response = registerWalletMutation.registerPayLaterWallets(registerPayLaterWalletInput) as RegisterPayLaterFailure
    ...
    void 'Register Pay later supplier wallets handle exceptions'() {
        ...
        def response = registerWalletMutation.registerPayLaterSupplierWallets(registerPayLaterWalletInput) as RegisterPayLaterFailure
        assert response.reason == exceptionMessage
    }
